...
var FieldValidations = function () {
  ...
  FieldValidations.prototype.getMessage = function (validn, field, data) {
    var message_templ = '';
    ...
    var var_names = __spreadArrays(['field'], Object.keys(validn.validator));

    var var_values = __spreadArrays([field], Object.values(validn.validator));

    var fn = new (Function.bind.apply(Function, __spreadArrays([void 0], var_names, ["return `" + message_templ + "`;"])))();
    var msg = fn.apply(void 0, var_values);
    return msg;
  };
...
}();var FieldValidationsWrapper = function () {
...
var Comparison = function () {
  ...
  Boel.prototype.addValidator = function (name, vfatory) {
    if (typeof name == 'string') {
      this.validator_makers[name] = function () {
        ...
        this.addValidation(vfatory.apply(void 0, args));
        return this;
      };
    } else {
      var names = name;
  ...
  Boel.prototype.validate = function (rules, data) {
    var error_map = {};

    for (var _i = 0, rules_1 = rules; _i < rules_1.length; _i++) {
      var rule = rules_1[_i];
      var field_errors = rule.validate(data);
      error_map = __assign(__assign({}, error_map), field_errors);
    }
  ...
  FileExtension.prototype.validate = function (field_name, data) {
    if (data[field_name]) {
      var ext = data[field_name].split('.').pop();
